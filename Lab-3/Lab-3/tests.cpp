...
{
	int* x{ new int[5]{ 1,2,3,5,9 } }, smax = 1, dmax = 0;
	secvMaxNrPrime(5, x, smax, dmax);
	assert(smax == 1);
	assert(dmax == 3);
	int* y{ new int[5]{ 12,14,22,80,500 } };
	secvMaxNrPrime(5, y, smax, dmax);
	assert(smax == 1);
	assert(dmax == 0);
	int* z{ new int[11] { 1,6,2,3,5,60,3,11,7,23,9 } };
	secvMaxNrPrime(11, z, smax, dmax);
	assert(smax == 6);
	assert(dmax == 9);
	int* t{ new int[4] { 2,3,5,11 } };
...
{
	int* x{ new int[5] { 1,1,2,3,3 } }, smax = 1, dmax = 0;
	secvMaxNrDistincte(5, x, smax, dmax);
	assert(smax == 1);
	assert(dmax == 3);
	int* y{ new int[5] { 12,12,12,12,12 } };
	secvMaxNrDistincte(5, y, smax, dmax);
	assert(smax == 1);
	assert(dmax == 0);
	int* z{ new int[10] { 1,1,1,2,2,3,4,5,5,5 } };
	secvMaxNrDistincte(10, z, smax, dmax);
	assert(smax == 4);
	assert(dmax == 7);
	int* t{ new int[11] { 1,2,3,5,7,7,11,13,9,10,15 } };
